...
TxHeader.TransmitGlobalTime = DISABLE;
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  //https://community.st.com/t5/stm32-mcus/can-bxcan-bit-time-configuration-on-stm32-mcus/ta-p/689864
	  // how to set up the can periphrial
	  //https://community.st.com/t5/stm32-mcus/guide-to-can-bxcan-can2-0-configuration-in-loop-back-mode-on/ta-p/771119
